...
public class SolvingQuiz extends JPanel implements ActionListener {
...
//      int timesec = 0;
      ...
      class quiz_thread extends Thread {
         ...
         public void run() {
            ...
            String msg = uv.getUser_gaming_cookie() + "/" + uv.getUser_gaming_correct_quiz() + "/" + result_user_gaming_time +"/"+ cnt+"/" + roomnumber+"/" + user_id;
